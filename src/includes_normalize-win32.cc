...
#ifdef NDEBUG
void AssertIsCanonicalInDebug(const StringPiece&) {
#else
void AssertIsCanonicalInDebug(const StringPiece& original) {
...
bool IncludesNormalize::MakePathAbsolute(std::string* s, string* err) {
